...
import {retrieveUser, update} from "../../Service/UserService";
...
const Profile = () => {
    ...
    const {id} = useParams();
    const [user, setUser] = React.useState<User>({id: 0, email: "", firstName: "", lastName: ""})
    React.useEffect(() => {
        const getUser = async () => {
            const userId = id || "";
            ...
            <ThemeProvider theme={theme}>
                <Container component="main" maxWidth="sm">
                    ...
                    <Box sx={{marginTop: 15, display: 'flex', flexDirection: 'column', alignItems: 'left'}}>
                        ...
                        <Button variant="outlined" sx={{padding: 2}} onClick={toggleEdit}> Edit  </Button>
                    </Box>
                </Container>
            </ThemeProvider>
        );
